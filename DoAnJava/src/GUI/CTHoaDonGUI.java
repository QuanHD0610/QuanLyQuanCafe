...
public class CTHoaDonGUI extends javax.swing.JFrame {
    ...
    /**
     * Creates new form CTHoaDonGUI
     */
    ArrayList<ChiTietHoaDon> dsChiTietHoaDons = new ArrayList<>();
    ...
    void hienThiDanhSachChiTietHoaDon() {
        int maHD = DataHolder.getMaHoaDon();
        dsChiTietHoaDons = ChiTietHoaDonDAO.layDanhSachChiTietHoaDon(maHD);
        DefaultTableModel dtm = new DefaultTableModel();
        String[] tieuDe = {"Mã hàng", "Tên hàng", "Số lượng", "Đơn giá", "Thành tiền"};
        dtm.setColumnIdentifiers(tieuDe);
        for (ChiTietHoaDon hh : dsChiTietHoaDons) {
